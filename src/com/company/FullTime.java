...
public class FullTime extends Employee{
    ...
    public FullTime(String ID, String name, int age, double baseSalary) throws SQLException, ClassNotFoundException {
        super(name,age,ID);
        this.baseSalary=baseSalary;
        ...
        super.setUserName(input.nextInt());
        System.out.println("Create user password : ");
        super.setUserPassword(input.nextInt());
        String query="insert into Part_time values (\""+ID+"\",\""+name+"\","+age+","+baseSalary+","+dayOff+","+getUserName()+","+getUserPassword()+");";
