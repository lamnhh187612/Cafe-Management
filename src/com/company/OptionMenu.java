    ...
    public void managerChoice1(Department department) throws SQLException, ClassNotFoundException {
        ...
        switch (choose){
            ...
            case 2:
                ...
                for(int i=0;i<department.getFullTimes().size();i++){
                    if(Objects.equals(department.getFullTimes().get(i).ID, temp)){
                        department.payEmployee(department.getFullTimes().get(i));
                    }
                }
                for(int i=0;i<department.getPartTimes().size();i++){
                    if(Objects.equals(department.getPartTimes().get(i).ID, temp)){
            ...
            case 4:
                ...
                if(type==2){
                    ...
                    FullTime staff=new FullTime(ID,name,age,pay);
                    ...
                    double pay=input.nextDouble();
                    PartTime staff=new PartTime(name,age,ID,pay);
                    done=department.addEmployee(staff);
                    if(done){
                        System.out.println("Added full-time employee!");
                    }
            ...
            case 5:
                ...
                String id=menuInput.nextLine();
                for(int i=0;i<department.getPartTimes().size();i++){
                    if(Objects.equals(id, department.getPartTimes().get(i).ID)){
                ...
                for(int i=0;i<department.getFullTimes().size();i++){
                    if(Objects.equals(id, department.getFullTimes().get(i).ID)){
