...
public class PartTime extends Employee{
    ...
    public PartTime(String name, int age,String ID, double payPerShift) throws SQLException, ClassNotFoundException {
        super(name,age,ID);
        time=0;
        this.payPerShift=payPerShift;
        ...
        String query="insert into Part_time values (\""+ID+"\",\""+name+"\","+age+","+payPerShift+","+time+","+getUserName()+","+getUserPassword()+");";
